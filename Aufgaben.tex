...
Zum ersten Abschnitten im Skript gibt es noch keine Übungen. Wir fangen
...
\begin{aufg}
  ...
  anderen Intervalle könnte man anstatt Quinten nehmen? Welche nicht? Kann man
...
\begin{aufg}
  ...
  vorgeschriebene Akkordfolge realisiert. (Tipps: Beginne mit dem Bass. Kümmere Dich nicht um die Taktart.)
  \begin{center}
    \hspace*{-2px}
...
\begin{aufg}
  Schreibe einen Chorsatz in einer D-Dur, der mit möglichst geringem
