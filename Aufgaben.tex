...
\begin{aufg}
  ...
  \begin{quote}
    \includegraphics{ly/e-grundton-1}\\[.5\baselineskip]
    \includegraphics{ly/e-grundton-2}\\[.5\baselineskip]
    \includegraphics{ly/e-grundton-3}
  \end{quote}
\end{aufg}
...
\begin{aufg}
  Lässt man den Grundton gleich, unterscheiden sich Modi nur in den
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-stufenAnalyse}
  \end{center}
  \begin{enumerate}
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-mittelstimmen}\\[-3px]
    \small \hspace*{17.8mm}%
    $\mut$\hspace*{3.7mm}%
    $\mus_3$\hspace*{1.3mm}%
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-atb}\\[-5px]
    \small\hspace*{22.2mm}%
    $\muT$\hspace*{2.3mm}%
    $\muD\mup$\hspace*{1.8mm}%
    $\muS$\hspace*{3.6mm}%
    $\muT$\hspace*{4.4mm}%
    $\muS\mup_3$\hspace*{.5mm}%
    $\muD$\hspace*{3.1mm}%
    $\muT$\hspace*{11.9mm}\vspace*{-4pt}
  \end{center}
\end{aufg}
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-vorhaltDurchgang}
  \end{center}
\end{aufg}
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-durchgangWechselnoten}\vspace*{5pt}
  \end{center}
\end{aufg}
...
verwendeten Funktionen. Alles bisher Bespro\-chene darf benutzt werden.
...
\begin{aufg}
  ...
  \begin{center}
    \hspace*{-3px}
    \includegraphics{ly/e-d7s65}\vspace*{12px}
    \vspace*{-5pt}
  \end{center}
\end{aufg}
...
\begin{aufg}
  ...
  \begin{center}
    \hspace*{-2px}
    \includegraphics{ly/e-chromatischeLeiter}\\[-6px]
...
\begin{aufg}
  ...
  \begin{center}
    \hspace*{-2px}
    \includegraphics{ly/e-akkordfolge}\\[-4px]
...
\begin{aufg}
  ...
  \begin{center}
    \includegraphics{ly/e-d79}\vspace*{10px}
  \end{center}
\end{aufg}
...
\begin{aufg}
  ...
  \begin{center}
    \hspace*{-2px}\includegraphics{ly/e-akkordfolge2}\\
